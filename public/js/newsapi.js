...
function _fetchData() {
  _fetchData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var url, options, response, data, noticia, container;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = 'https://bing-news-search1.p.rapidapi.com/news?count=5&category=Sports&cc=GB&safeSearch=Off&textFormat=Raw';
          options = {
            method: 'GET',
            headers: {
        ...
        case 8:
          ...
          noticia.forEach(function (article) {
            ...
            var fecha = new Date(article.datePublished).toLocaleDateString('es-ES');
